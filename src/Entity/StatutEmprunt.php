...
class StatutEmprunt
{
    ...
    #[ORM\OneToMany(mappedBy: 'statutEmprunt', targetEntity: Emprunt::class)]
    private Collection $emprunts;

    #[ORM\ManyToOne(inversedBy: 'enregistreStatutEmprunts')]
    private ?User $enregistrePar = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE)]
    private ?\DateTimeInterface $enregistreLeAt = null;

    #[ORM\ManyToOne(inversedBy: 'modifieStatutEmprunts')]
    private ?User $modifiePar = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $modifieLeAt = null;

    #[ORM\ManyToOne(inversedBy: 'supprimeStatutEmprunts')]
    ...
    public function removeEmprunt(Emprunt $emprunt): self
    {
        if ($this->emprunts->removeElement($emprunt)) {
            ...
            if ($emprunt->getStatutEmprunt() === $this) {
