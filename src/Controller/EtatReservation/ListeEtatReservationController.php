...
class ListeEtatReservationController extends AbstractController
{
    ...
    #[Route('/liste-statut-emprunt/{a<[0-1]{1}>}/{m<[0-1]{1}>}/{s<[0-1]{1}>}', name: 'liste_etatReservation')]
    public function listeEtatReservation(Request $request, int $a = 0, int $m = 0, int $s = 0): Response
    {
        ...
        return $this->render('etatReservation/listeEtatReservation.html.twig', [
