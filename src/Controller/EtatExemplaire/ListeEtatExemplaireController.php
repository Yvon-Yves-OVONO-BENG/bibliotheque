...
class ListeEtatExemplaireController extends AbstractController
{
    ...
    #[Route('/liste-statut-emprunt/{a<[0-1]{1}>}/{m<[0-1]{1}>}/{s<[0-1]{1}>}', name: 'liste_etatExemplaire')]
    public function listeEtatExemplaire(Request $request, int $a = 0, int $m = 0, int $s = 0): Response
    {
        ...
        return $this->render('etatExemplaire/listeEtatExemplaire.html.twig', [
