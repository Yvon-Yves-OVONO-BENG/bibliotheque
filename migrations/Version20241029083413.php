 ...
 */
final class Version20241029083413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE armoire (id INT AUTO_INCREMENT NOT NULL, armoire VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE auteur (id INT AUTO_INCREMENT NOT NULL, nationalite_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_naissance_at DATE NOT NULL, biographie VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_55AB1401B063272 (nationalite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nationalite (id INT AUTO_INCREMENT NOT NULL, nationalite VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE penalite (id INT AUTO_INCREMENT NOT NULL, membre_id INT DEFAULT NULL, statut_paiement_id INT DEFAULT NULL, montant INT NOT NULL, date_application_at DATETIME NOT NULL, INDEX IDX_C62D8C5D6A99F74A (membre_id), INDEX IDX_C62D8C5D53E537D1 (statut_paiement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, membre_id INT DEFAULT NULL, livre_id INT DEFAULT NULL, statut_reservation_id INT DEFAULT NULL, date_reservation_at DATETIME NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_42C849556A99F74A (membre_id), INDEX IDX_42C8495537D925CB (livre_id), INDEX IDX_42C84955C583C008 (statut_reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD membre_id INT DEFAULT NULL, ADD slug VARCHAR(255) NOT NULL, ADD bloque TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP membre_id, DROP slug, DROP bloque');
    }
}
