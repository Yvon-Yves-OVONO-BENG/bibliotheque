 ...
 */
final class Version20241101190016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auteur ADD type_auteur_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE auteur ADD CONSTRAINT FK_55AB140D47D2EF6 FOREIGN KEY (type_auteur_id) REFERENCES type_auteur (id)');
        $this->addSql('CREATE INDEX IDX_55AB140D47D2EF6 ON auteur (type_auteur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_55AB140D47D2EF6 ON auteur');
        $this->addSql('ALTER TABLE auteur DROP type_auteur_id');
    }
}
