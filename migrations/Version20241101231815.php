 ...
 */
final class Version20241101231815 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD enregistre_par_id INT DEFAULT NULL, ADD enregistre_le_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre DROP enregistre_par_id, DROP enregistre_le_at');
    }
}
